...
namespace KinematicCharacterController.Examples
{
    ...
    public class ExampleCharacterController : MonoBehaviour, ICharacterController
    {
        ...
        public float JumpUpSpeed = 20f;
        public float miniJumpUpSpeed = 10f;
        ...
        private bool _miniJumpRequested = false;
        private bool _majorJumpConsumed = false;
                ...
                case CharacterState.Default:
                    {
                        ...
                        if (_jumpRequested || _miniJumpRequested)
                        {
                            // See if we actually are allowed to jump
                            if ((_jumpRequested && !_majorJumpConsumed) || (!_jumpConsumed && 
                                ...
                                _timeSinceLastAbleToJump <= JumpPostGroundingGraceTime)))
                            {
                                ...
                                animationController.ToggleBool("midair", true);
                            }
                         
                            _jumpRequested = _miniJumpRequested = false;
                        }
        ...
        {
            animationController.ToggleBool("midair", false);
        }
